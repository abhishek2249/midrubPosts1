  ...
  <ul class="nav nav-pills mb-3" id="taBB">
                                            ...
                                            <?php echo form_open('user/app/phpanalyzer', ['id' => 'get-user-detail', 'data-csrf' => $this->security->get_csrf_token_name()]) ?>
                                                <div class="div_diff">
                                                    <div class="basic-dropdown">
                                                        ...
                                                        <input type="text" placeholder="Enter page username" name="username" id="username"></h4>
                                                        
                                                        <div class="basic-dropdown float-right" id="mobile-left">
                                                            <div class="dropdown">
                                                            <button type="submit" id="search-user-button" class="btn btn-primary action-button2" id="search-user">Search</button>
							    ...
							    <div id="profile_card"></div>							 
                                    ...
                                    <div id="navpills-2" class="tab-pane">
                                        <div class="row align-items-center">
                                           <div class="col-lg-12">
                                          <img src="images/sch-graph.jpg" width="100%"> </div> 
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="div_diff">
                                                            <?php echo form_open('user/app/phpanalyzer', ['id' => 'compare-user-detail', 'data-csrf' => $this->security->get_csrf_token_name()]) ?>
                                                                <div class="basic-dropdown">
                                                                    <div class="dropdown">
                                                                        <!-- <button type="button" class="btn btn-primary dropdown-toggle action-button" data-toggle="dropdown" aria-expanded="false">Facebook</button> -->
                                                                        <input type="text" name="f_username" id="f_username" class="form-control" />
                                                                        <div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(207px, -107px, 0px); top: 0px; left: 0px; will-change: transform;"><a class="dropdown-item" href="#">Twitter</a> <a class="dropdown-item" href="#">Linkedin</a> <a class="dropdown-item" href="#">Instagram</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
        ...
        <!--compare report tab top-->
							...
							<h4 class="color">Top Posts <em>Top posts from the last 6 posts</em></h4>
								...
								<img src="images/social-ad.jpg" class="img-fluid">
								</div>								
							...
							<div class="col-lg-4 col-md-4 col-sm-6 float-left">
								...
								<img src="images/adi.png" class="img-fluid text-center">
                            ...
                            <div class="card" id="white">
								...
								<div class="col-lg-3 col-md-3 col-sm-6 float-left">
								<img src="images/ree.png" class="img-fluid text-center">
								...
								<div class="col-lg-3 col-md-3 col-sm-6 float-left">
								<img src="images/guc.png" class="img-fluid text-center">
                            ...
                            <div class="card" id="white">
								...
								<div class="table-responsive stats">
                                    <table class="table header-border">
                                        ...
                                        <tbody>
                                            <tr>
											<td><img src="images/adi.png" width="30"></td>
											<td>Followers</td>
                                                <td>7,707,709
                                                </td>
                                                <td>7,707,709</td>
